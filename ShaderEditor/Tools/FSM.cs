// see https://habrahabr.ru/post/206120/
...
namespace ShaderEditor
{
    ...
    public class FiniteStateMachine<S>
    {
        ...
        public void AddTransition(S init, S end, Callback c)
        {
            ...
            {
                Debug.Write("[FSM] Transition: " + tr.GetInitState() + " - " + tr.GetEndState() + " exists already.");
                return;
            }

            mTransitions.Add(tr, c);

            Debug.Write("[FSM] Added transition " + mTransitions.Count + ": " + tr.GetInitState() + " - " + tr.GetEndState()
              + ", Callback: " + c);
        }
